...
multica skill files <skill-id> upload <path>

# 从 GitHub 导入
multica skill import --from-github https://github.com/owner/repo/tree/main/skills/my-skill
...
```bash
multica agent skills <agent-slug> add    --skill-id <id>
multica agent skills <agent-slug> remove --skill-id <id>
multica agent skills <agent-slug> list
```
...
Multica 当前 **MCP 支持只有 Claude Code 真的消费**——其他工具会接收 MCP 配置但不实际用。详见 [12-providers.md](12-providers.md)。
...
下一步：[10-squads.md](10-squads.md) — 小队如何路由工作。
