...
| `apps/docs/content/docs/skills.zh.mdx` | [10-skills.md](10-skills.md), [15-build-a-skill.md](15-build-a-skill.md)（操作步骤 / 决策清单） |
| `apps/docs/content/docs/squads.zh.mdx` | [11-squads.md](11-squads.md), [16-build-a-squad.md](16-build-a-squad.md)（操作步骤 / 决策清单） |
| `apps/docs/content/docs/autopilots.zh.mdx` | [12-autopilots.md](12-autopilots.md), [17-build-an-autopilot.md](17-build-an-autopilot.md)（操作步骤 / 决策清单） |
...
| `multica agent create --help` / `multica agent skills set --help`（v0.3.10 实测） | [07-build-an-agent.md](07-build-an-agent.md), [10-skills.md](10-skills.md), [15-build-a-skill.md](15-build-a-skill.md), [appendix-cli.md](appendix-cli.md) |
| `multica skill create --help` / `multica skill files upsert --help` / `multica skill import --help`（v0.3.10 实测） | [10-skills.md](10-skills.md), [15-build-a-skill.md](15-build-a-skill.md) |
| `multica squad create --help` / `multica squad member add --help` / `multica squad activity --help`（v0.3.10 实测） | [11-squads.md](11-squads.md), [16-build-a-squad.md](16-build-a-squad.md) |
| `multica autopilot create --help` / `multica autopilot trigger-add --help` / `multica autopilot trigger-rotate-url --help`（v0.3.10 实测） | [12-autopilots.md](12-autopilots.md), [17-build-an-autopilot.md](17-build-an-autopilot.md) |

## 抽取原则

- **不替代官方文档**——这里只挑 Agent 实际操作时反复需要的部分。完整功能列表、产品演进、运维细节仍然以上游为准。
- **优先压缩**——上游一段 800 字的概念描述往往可以压成 5 行表 + 2 个命令。把表面的长描述删了，行为约束留下。
- **"操作指引型"章节优先采集 `--help` 实测输出**——03 / 07 / 15 / 16 / 17 以"Agent 接到任务后该走哪几步"为主轴，命令片段直接来自 `multica <cmd> --help` 的当前输出，不靠记忆 / 旧文档。
